...
- `architecture/input-and-tooling-flow.md`
...
- Review model tiering and input pipeline
- Use deployment docs to operationalize builds and releases
- Use tech docs for runtime and algorithm-level decisions
