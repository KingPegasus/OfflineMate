...
1. **Input**
   ...
   - Voice: the mic records the full clip while the user holds the button; on release, Whisper transcribes the complete audio buffer in a single `transcribeData` pass. That text becomes the message.
